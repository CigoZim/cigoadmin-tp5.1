<?php
namespace app\cigoadmin\library\encrypt;
...
public class PingDuoDuoReduceRule implements ReduceRule {
    ...
    private final int percentOfFirstNReduce;//前N个人比例
    private final int firstNReduce;//前N个人
    ...
    public static void main(String[] args) {
        PingDuoDuoReduceRule rule = new PingDuoDuoReduceRule(1, 1);
        List<BigDecimal> list = rule.getReduceList(new BigDecimal("100.21"), 5);
